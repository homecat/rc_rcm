   ...
   <table id="from" cellspacing="0" cellpadding="5" class="fl" height="526" width="280">
                <tbody class="editBox itemlist lh24">
                    ...
                    <tr>
                        <td>渠道</td>
                        <td colspan="3">
                        	<select id="channel" name="channel" class="sWidth">
                                <option value="">请选择</option>
                                <?php echo $this->member_params_model->get_parm_option('渠道', $row['channel']); ?>
                            </select></td>
                    </tr>
                    <tr>
                        <td>负责人</td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                        	...
                        	<input type="hidden" id="khzi" name="khzi" value='1'   />
                        </td>
                    </tr>
                    <tr>
                        <td>建立时间</td>
...
$(option_button).click(function(){
	window.parent.document.getElementById('khzi').value=$("#khzi").val();
	...
	window.parent.document.getElementById('channel').value=$("#channel").val(); 
